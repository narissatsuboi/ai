...
class StayEastSearchAgent(SearchAgent):
    ...
    def __init__(self):
        ...
        self.searchType = lambda state: PositionSearchProblem(state, costFn, (1, 1), None,
                                                              False)
...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.startingPosition, tuple([c for c in self.corners])
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST,
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextxy in cornersToFind:
                    cornersToFind.remove(nextxy)
                successors.append(((nextxy, tuple(cornersToFind)), action, 1))
